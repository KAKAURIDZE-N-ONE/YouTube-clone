...
const videosArr = [
  [
    ...
    {
      videoImg:
        'https://i.ytimg.com/vi/86g3-PM6K5E/hq720.jpg?sqp=-oaymwEcCNAFEJQDSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLCSUhr6A9ghvucw7Mn6vEX_yg9jpg',
      pageImg:
  ...
  [
    {
      shortImg:
        'https://i.ytimg.com/vi/zPxQjuFoUBc/oar2.jpg?sqp=-oaymwEdCJUDENAFSFWQAgHyq4qpAwwIARUAAIhCcAHAAQY=&rs=AOn4CLBEzhO00BE14m9Z5SslJjB4nfwttw',
      heading: 'დეკემბერი #ღამისშოუსბენდი',
      views: '19K views',
    },
    {
      shortImg:
        'https://i.ytimg.com/vi/VAOXIR4REgo/oar2.jpg?sqp=-oaymwEdCJUDENAFSFWQAgHyq4qpAwwIARUAAIhCcAHAAQY=&rs=AOn4CLB2YfH2FWD69c4v3V-Scy5XagjhRQ',
      heading: 'Levan“Hulk”Saginashvili vs Konstantine“Georgian Bull”',
      views: '338K views',
    },
    {
      shortImg:
        'https://i.ytimg.com/vi/-ubcgJ_4CPE/oar2.jpg?sqp=-oaymwEdCJUDENAFSFWQAgHyq4qpAwwIARUAAIhCcAHAAQY=&rs=AOn4CLCqjSrP7IuhlgNGap1zR_ayKyC3Ig',
      heading: 'Salome Kapanadze და wupaka',
      views: '114k views',
    },
    {
      shortImg:
        'https://i.ytimg.com/vi/_gvT7B96q_s/oardefault.jpg?sqp=-oaymwEdCJUDENAFSFWQAgHyq4qpAwwIARUAAIhCcAHAAQY=&rs=AOn4CLCqN7tCClXxf6GBDqpiSFOt7TfOlA',
      heading: 'Peanut butter cookies 🍪',
      views: '2M views',
    },
    {
      shortImg:
        'https://i.ytimg.com/vi/LZ4j5LnB9vY/oar2.jpg?sqp=-oaymwEdCJUDENAFSFWQAgHyq4qpAwwIARUAAIhCcAHAAQY=&rs=AOn4CLC4teoTAZGZC6OPV_a8WbtLr0LQQw',
      heading: 'Levan VS Aziz',
      views: '203M views',
    },
    {
      shortImg:
        'https://i.ytimg.com/vi/rE1SUCqRBp4/oar2.jpg?sqp=-oaymwEdCJUDENAFSFWQAgHyq4qpAwwIARUAAIhCcAHAAQY=&rs=AOn4CLA61XG-GnUZ87a7c-IfUEs7mipoTQ',
      heading: 'Her eyes 🖤| Robin Hood #shorts #love',
      views: '8.3M views',
    },
    {
      shortImg:
        'https://i.ytimg.com/vi/AybaCoAZdSY/oar2.jpg?sqp=-oaymwEdCJUDENAFSFWQAgHyq4qpAwwIARUAAIhCcAHAAQY=&rs=AOn4CLAXzqbh9QPiSITAjuwrEVeO6BGzWQ',
      heading:
        'Random shots of the beautiful people #streetphotographytips #streetphotography',
      views: '33M views',
    },
    {
      shortImg:
        'https://i.ytimg.com/vi/E5WjgMQ1Gew/hq720.jpg?sqp=-oaymwEdCJUDENAFSFXyq4qpAw8IARUAAIhCcAHAAQbQAQE=&rs=AOn4CLB3wxGIqJYkyizh00DRYXEnQjh_LA',
      heading: "She🖤 or dilaraa💚or dilaraa's sister❤?😩🔥",
      views: '2M views',
    },
  ],
];
...
app.get('/', (req, res) => {
  res.send('Welcome to the video server!'); // Sending a simple welcome message for the root URL
});

app.get('/videos', (req, res) => {
  const videosString = JSON.stringify(videosArr); // Convert array to a JSON string
  res.send(videosString); // Send the string response for '/videos'
});
